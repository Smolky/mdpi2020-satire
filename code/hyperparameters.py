...
def create_model (x_train, y_train, x_val, y_val, params):
    ...
    if (params['word_embeddings_architecture'] == 'dense'):
        main_embeddings_2 = GlobalMaxPool1D ()(main_embeddings_1)
        ...
        main_embeddings_5 = Dense (second_neuron, activation=params['activation'])(main_embeddings_4)
        main_embeddings_6 = Dropout (params['dropout'])(main_embeddings_5)
    ...
    if (params['word_embeddings_architecture'] == 'bilstm'):
        main_embeddings_2 = SpatialDropout1D (params['dropout'])(main_embeddings_1)
        main_embeddings_3 = Bidirectional (LSTM (first_neuron, dropout=params['dropout'], recurrent_dropout=params['dropout']))(main_embeddings_2)
...
for key, umucorpus_ids in config.ids[args.dataset].items ():
    ...
    glove_embedding_matrix = create_embedding_matrix ("glove.txt", tokenizer.word_index, 100, args.dataset)
    ...
    p = {
        ...
        'first_neuron': [12, 24, 48, 96, 192],
        'reduce_dim': [True, False],
        'batch_size': [16, 32, 64],
        'dropout': [0.2, 0.5, 0.8],
        'word_embeddings_architecture': ['cnn', 'bilstm', 'gru', 'dense'],
        'activation': ['relu', 'sigmoid', 'softmax', 'tanh', 'selu', 'elu'],
        'embedding_matrix': [
